...
return new class extends Migration {
	...
	public function up()
	{
		Schema::create('vehicles', function (Blueprint $table) {
			...
			$table->integer('zdvihovy_objem_cm3')->nullable();
			...
			$table->string('co2_mesto_mimo_kombi_gkm', 10)->nullable();
			$table->string('specificke_co2', 10)->nullable();
			...
			$table->string('spotreba_mesto_mimo_kombi_l100km', 15)->nullable();
			$table->string('spotreba_pri_rychlosti_l100km', 6)->nullable();
